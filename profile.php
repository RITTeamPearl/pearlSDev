            ...
            <form class='formContainer' action='profile.php' method='POST'>
                ...
                <div class="formStep" id="formStep1">
                    <div class='inputWithIcon'>
                        ...
                        <input class='block' id='phoneNumber' type = 'text' placeholder= 'Phone Number' name='phoneNumber'>
                    ...
                    <input class='block submit centered' id='save' type = 'button' value= 'Save Changes' onclick="nextStepTwo(4)"/>
                </div>
            </form>
